...
boucle_tmr6
			btfss INTCON,TMR0IF ; Test bit T0IF de INTCON
			goto boucle_tmr6 ; boucle d'attente si timer non nul
			bcf INTCON,TMR0IF ; RAZ du drapeau
			bcf signal ; mise ?1 de la sortie		
			movwf TMR0 ; Chargement du registre de travail dans TMR0
boucle_tmr66
			btfss INTCON,TMR0IF ; Test bit T0IF de INTCON
			goto boucle_tmr66 ; boucle d'attente si timer non nul
			bcf INTCON,TMR0IF ; RAZ du drapeau
			bsf signal ; mise ?1 de la sortie
			movlw duree ; Chargement de la duree dans le registre de travail
			movwf TMR0 ; Chargement du registre de travail dans TMR0
boucle_tmr7
			btfss INTCON,TMR0IF ; Test bit T0IF de INTCON
			goto boucle_tmr7 ; boucle d'attente si timer non nul
			bcf INTCON,TMR0IF ; RAZ du drapeau
			bcf signal ; mise ?1 de la sortie		
			movwf TMR0 ; Chargement du registre de travail dans TMR0
boucle_tmr77
			btfss INTCON,TMR0IF ; Test bit T0IF de INTCON
			goto boucle_tmr77 ; boucle d'attente si timer non nul
			bcf INTCON,TMR0IF ; RAZ du drapeau
			bsf signal ; mise ?1 de la sortie
			movlw duree ; Chargement de la duree dans le registre de travail
			movwf TMR0 ; Chargement du registre de travail dans TMR0
boucle_tmr8
			btfss INTCON,TMR0IF ; Test bit T0IF de INTCON
			goto boucle_tmr8 ; boucle d'attente si timer non nul
			bcf INTCON,TMR0IF ; RAZ du drapeau
			bcf signal ; mise ?1 de la sortie		
			movwf TMR0 ; Chargement du registre de travail dans TMR0
boucle_tmr88
			btfss INTCON,TMR0IF ; Test bit T0IF de INTCON
			goto boucle_tmr88 ; boucle d'attente si timer non nul
			bcf INTCON,TMR0IF ; RAZ du drapeau
